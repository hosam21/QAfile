...
def index_documents(summaries: List[str], originals: List[str], doc_type: str, id_key: str, vectorstore, docstore):
    """
...
def process_pdf(pdf_path):
    ...
    # Index documents
    index_documents(text_summaries, text_originals, "text", id_key, vectorstore, docstore)
    index_documents(table_summaries, table_originals, "table", id_key, vectorstore, docstore)
    index_documents(image_summaries, image_originals, "image", id_key, vectorstore, docstore)
